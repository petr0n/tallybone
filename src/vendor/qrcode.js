...
//
//   Package: qrcode-generator@2.0.4  (dist/qrcode.mjs, verbatim below)
//   Source:  https://registry.npmjs.org/qrcode-generator/-/qrcode-generator-2.0.4.tgz
//   shasum:  e8b3f30922577eba52078aa9c0d5a2a74fe1fd94
//   License: MIT (full header retained below)
//
// Vendored rather than depended on so the join QR is generated ON DEVICE with
// no external image service — the join code never leaves the phone, and the
// Create/Lobby screens keep working offline. Only `getModuleCount()` and
// `isDark(r,c)` are used; src/components/qr.js does the drawing.
//
// To update: re-run `npm pack qrcode-generator@<version>` and replace the body
// below with dist/qrcode.mjs unchanged, refreshing the version/shasum above.
